...
const TermsPage: NextLayoutComponentType = () => {
  return (
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-5 text-white text-left">
                ...
                <p>
                  This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and
            ...
            <div className="col-lg-3 mb-lg-0 mb-5 mt-3 mt-md-5 mt-lg-0">
              <ul className="nav flex-column bg-white border-radius-lg p-3 position-sticky top-10 shadow-lg">
                <li className="nav-item">
                  <a className="nav-link text-dark d-flex align-items-center" data-scroll href="#general-terms">
                    <i className="material-icons text-dark opacity-5 pe-2">widgets</i>
                    General Terms
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-dark d-flex align-items-center" data-scroll href="#cookies">
                    <i className="material-icons text-dark opacity-5 pe-2">cookie</i>
                    Cookies
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-dark d-flex align-items-center" data-scroll href="#license">
                    <i className="material-icons text-dark opacity-5 pe-2">description</i>
                    License
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-dark d-flex align-items-center" data-scroll href="#hyperlinking">
                    <i className="material-icons text-dark opacity-5 pe-2">insert_link</i>
                    Hyperlinking
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-dark d-flex align-items-center" data-scroll href="#iframes">
                    <i className="material-icons text-dark opacity-5 pe-2">filter_frames</i>
                    iFrames
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-dark d-flex align-items-center" data-scroll href="#liability">
                    <i className="material-icons text-dark opacity-5 pe-2">campaign</i>
                    Liability
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-dark d-flex align-items-center" data-scroll href="#disclaimer">
                    <i className="material-icons text-dark opacity-5 pe-2">wysiwyg</i>
                    Disclaimer
                  </a>
                </li>
              </ul>
              ...
              <div className="card shadow-lg mb-5">
                <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                  <div className="bg-gradient-primary shadow-primary border-radius-lg p-3">
                    ...
                    <p className="text-white opacity-8 mb-0">Last modified: Aug 27 2021</p>
                  </div>
                </div>
                <div className="card-body p-5">
                  <p id="general-terms">Welcome to Creative Tim!</p>
                  <p>
                    These terms and conditions outline the rules and regulations for the use of Creative Tim's Website,
                    located <a href="https://www.creative-tim.com/">here</a>.
                  </p>
                  <p>
                    By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Creative Tim if you do not agree to take all of the terms and conditions stated on this page.
                  </p>
                  <p>
                    ...
                    of Netherlands. Any use of the above terminology or other words in the singular, plural, capitalization
                    and/or he/she or they, are taken as interchangeable and therefore as referring to same.
                  </p>
                  <h3 className="mt-5 mb-3" id="cookies">
                    Cookies
                  </h3>
                  <p>
                    We employ the use of cookies. By accessing Creative Tim, you agreed to use cookies in agreement with the
                    Creative Tim's Privacy Policy.{' '}
                  </p>
                  <p>
                  ...
                  <h3 className="mt-5 mb-3" id="license">
                    License
                  </h3>
                  <p>
                    Unless otherwise stated, Creative Tim and/or its licensors own the intellectual property rights for all
                    material on Creative Tim. All intellectual property rights are reserved. You may access this from
                    Creative Tim for your own personal use subjected to restrictions set in these terms and conditions.
                  </p>
                  <p>You must not:</p>
                  <ul>
                  ...
                  <p>
                    ...
                    certain areas of the website. Creative Tim does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of Creative Tim,its agents
                    and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, Creative Tim shall not be liable for the Comments
                    or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting
                    of and/or appearance of the Comments on this website.
                  </p>
                  <p>
                    Creative Tim reserves the right to monitor all Comments and to remove any Comments which can be
                  ...
                  <p>
                    You hereby grant Creative Tim a non-exclusive license to use, reproduce, edit and authorize others to
                    use, reproduce and edit any of your Comments in any and all forms, formats or media.
                  </p>
                  <h3 className="mt-5 mb-3" id="hyperlinking">
                  ...
                  <p>
                    ...
                    absence of Creative Tim; and (d) the link is in the context of general resource information.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    website, you must inform us by sending an e-mail to Creative Tim. Please include your name, your
                    organization name, contact information as well as the URL of your site, a list of any URLs from which you
                    intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait
                  ...
                  <p>
                    No use of Creative Tim's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.
                  </p>
                  <h3 className="mt-5 mb-3" id="iframes">
                    iFrames
                  </h3>
                  <p>
                  ...
                  <h3 className="mt-5 mb-3" id="liability">
                    Content Liability
                  </h3>
                  <p>
                  ...
                  <h3 className="mt-5 mb-3">Your Privacy</h3>
                  <p>Please read Privacy Policy</p>
                  <h3 className="mt-5 mb-3">Reservation of Rights</h3>
                  <p>
                  ...
                  <h3 className="mt-5 mb-3">Removal of links from our website</h3>
                  <p>
                  ...
                  <h3 className="mt-5 mb-3" id="disclaimer">
                    Disclaimer
                  </h3>
                  <p>
