            ...
            <div
              ...
              <div className=" border-radius-lg bg-white px-4 py-4 shadow">
                {item?.image?.data?.attributes?.url && (
                  <div
                    className="icon icon-md icon-shape bg-gradient-primary shadow-primary shadow text-center border-radius-xl mb-2"
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center'
                    }}>
                    {/* <i className="material-icons opacity-10">{item?.image}</i> */}
                    <img src={item?.image?.data?.attributes?.url} width={20} />
                  </div>
                )}
