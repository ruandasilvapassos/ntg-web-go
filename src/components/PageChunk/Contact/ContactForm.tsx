                ...
                <form role="form" id="contact-form" method="post" autoComplete="off">
                  <div className="card-body">
                    <div className="row">
                      <div className="col-md-6">
                        <div className="input-group input-group-static mb-4">
                          ...
                          <input className="form-control" placeholder="eg. Jack" aria-label="First Name..." type="text" />
                        </div>
                      </div>
                      <div className="col-md-6 ps-2">
                        <div className="input-group input-group-static">
                          <label>Last Name</label>
                          <input type="text" className="form-control" placeholder="eg. Samuel" aria-label="Last Name..." />
                        </div>
                      </div>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                      <div className="input-group input-group-static">
                        <label>Company</label>
                        <input type="texy" className="form-control" placeholder="eg. Microsoft" aria-label="Company..." />
                      </div>
                    </div>
                    <div className="mb-4">
                      <div className="input-group input-group-static">
