      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-7">
            <h2>What we do</h2>
            <p>
              We are an energetic and dynamic organization that employs people with innovative ideas. Each team within our
              organization is integral to serving our clients to ensure the best service possible. Our people relish
              challenges, can solve complex problems and thrive on responsibility.
            </p>
          </div>
        </div>
